...
def all_nni(newick_file):
	...
	try:
		...
		print('could not complete the all_SPR function on dataset:', newick_file, '\nError message:')
		print(e)
		exit()
	finally:
	...
	"""
	# START OF FEATURES COLLECTION
	# feature collection on nni trees is not needed for the hybrid NNI
	#
...
if __name__ == "__main__":
    ...
    # old code from original NNI code starts here
	#starting_trees = glob.glob(f"/home/ctcomia/mlpti/training_data/hybrid_testing/training_data/**/real_msa.phy_phyml_tree_bionj.txt", recursive=True)
